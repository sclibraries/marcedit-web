...
_SPECIAL: dict[str, dict[str, Any]] = {
    ...
    "rda-classify-material": {
        ...
        "example": {"before": "Leader/06=m", "after": "336 $a computer program $b cop\n337 $a computer $b c\n338 $a online resource $b cr"},
    ...
    "rda-normalize-relators": {
        ...
        "example": {"before": "100 1  $a Doe $4 aut", "after": "100 1  $a Doe $e author"},
        "stored_representation": "The operation kind selects the checked-in mapping table.",
        "related": ["rda-mark-rda"],
    },
    "rda-promote-260": {
        ...
        "example": {"before": "260    $a Boston : $b Press, $c 2024", "after": "264    $a Boston : $b Press, $c 2024"},
...
_EXAMPLES: dict[str, tuple[str, str]] = {
    ...
    "rda-classify-material": ("Leader/06=m", "336 $a computer program $b cop\n337 $a computer $b c\n338 $a online resource $b cr"),
    ...
    "rda-normalize-relators": ("100 1  $a Doe $4 aut", "100 1  $a Doe $e author"),
    "rda-promote-260": ("260    $a Boston : $b Press, $c 2024", "264    $a Boston : $b Press, $c 2024"),
